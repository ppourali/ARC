...
namespace Mehr
{
    class ghabz
    {
        ...
        public void Add()
        {
            ...
            new action_logs().Add("صدور قبض برای بیمار با شماره پرونده ی " + this.id + " - مشخصه قبض " + this.ghabz_id);
        }
        ...
        public void Delete()
        {
            ...
            new action_logs().Add("حذف قبض به مشخصه ی " + this.ghabz_id);
        }
        ...
        public void Update()
        {
            ...
            new action_logs().Add("ویرایش قبض به مشخصه ی " + this.ghabz_id);
        }
