...
namespace BugForNowrouz
{
    class sick_history_daftari
    {
        ...
        {
            radif = Selectmaxid();
            string s = "INSERT INTO sick_history_daftari (radif, ghabz_id,sharh,date,sick_id,bedehkari,bestankari,tashkhis,mandeh) VALUES ({0}, N'{1}', N'{2}', N'{3}', N'{4}', {5}, {6}, N'{7}', {8}) ";
        ...
        {
            string s = "select max(radif) from sick_history_daftari where (sick_id=N'"+this.sick_id+"')";
            da.Connect();
        ...
        public void Delete()
        {
            string s = "Delete from sick_history_daftari where (ghabz_id=N'{0}')";
        ...
        {
            string s = "Delete from sick_history_daftari";
            da.Connect();
            da.docommand(s);
            da.disconnect();
        }
        ...
        {
            string s = "UPDATE sick_history_daftari SET  bedehkari = {0}, bestankari={1}, tashkhis=N'{2}', mandeh=N'{3}' WHERE (radif=1 and sick_id = N'{4}')";
        ...
        {
            string s = "UPDATE sick_history_daftari SET radif={0}, tashkhis = N'{1}', mandeh={2} WHERE (radif={3} and sick_id=N'{4}')";
        ...
        {
            string s = "UPDATE sick_history_daftari SET  bedehkari = {0}, bestankari={1}, date=N'{2}' WHERE (ghabz_id=N'{3}' and sick_id = N'{4}' and sharh=N'{5}')";
        ...
        {
            string s = "SELECT * FROM sick_history_daftari WHERE (sick_id=N'{0}') order by radif";
        ...
        {
            string s = "SELECT * FROM sick_history_daftari WHERE (sick_id=N'{0}') Order by radif ASC";
            s = string.Format(s, this.sick_id);
            da.Connect();
            DataTable dt = new DataTable();
            dt = da.select(s);
