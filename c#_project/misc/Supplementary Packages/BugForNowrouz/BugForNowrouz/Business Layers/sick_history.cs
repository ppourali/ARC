...
namespace BugForNowrouz
{
    class sick_history
    {
        ...
        {
            string s = "UPDATE sick_history SET  bedehkari = {0}, bestankari={1} WHERE (ghabz_id=N'{2}' and sick_id = N'{3}' and sharh=N'{4}')";
            s = string.Format(s, this.bedehkari, this.bestankari, this.ghabz_id, this.sick_id, this.sharh);
            da.Connect();
            da.docommand(s);
